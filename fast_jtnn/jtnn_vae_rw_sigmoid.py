...
from .uniform_reward_net_total_onehot_testflat_sigmoid import RewardNet_onehot_sigmoid

vocab_size = VOCAB_SIZE
class JTNNVAE_RW_SIGMOID(nn.Module):

    def __init__(self, hidden_size, latent_size, depthT, encoding, pred_prop):
        super(JTNNVAE_RW_SIGMOID, self).__init__()
        ...
        if pred_prop:
            self.predictor = RewardNet_onehot_sigmoid(input_length = 28, n_hidden_layers=1, hidden_layer_size = 128,
